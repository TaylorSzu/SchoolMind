...
namespace School_Mind.Data
{
    ...
    {
        public SchoolMindContext(DbContextOptions<SchoolMindContext> options)
            : base(options) { }
        ...
        public DbSet<AttendanceList> Attendances { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder
                .Entity<TeachingMaterial>()
                .HasOne(t => t.Creator)
                .WithMany(t => t.TeachingMaterials)
            ...
            modelBuilder.Entity<AttendanceList>().HasOne(a => a.Student)
                .WithMany(s => s.AttendanceLists)
